    ...
    >
      ...
      <article className="border-t border-line/70 pt-8 first:border-t-0 first:pt-0">
        ...
        <ul className="mt-3 space-y-2 text-sm leading-7 text-foreground-soft">
          ...
          <li>• <strong>Steer or stop it.</strong> <code>spaces agent interrupt</code> nudges an agent (sends Escape) and marks it idle, so a cancelled turn stops reading as work in progress, and <code>spaces agent kill</code> ends it and its terminal.</li>
