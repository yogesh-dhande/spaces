    ...
    >
      <article className="border-t border-line/70 pt-8 first:border-t-0 first:pt-0">
        ...
        <ul className="mt-3 space-y-2 text-sm leading-7 text-foreground-soft">
          ...
          <li>• Processes run inside tmux, so if you close the terminal the process keeps running and Spaces can reattach it to a new window.</li>
        </ul>
      </article>
...
SPACES_WORKSPACE_DIR              # this workspace's directory`}</code>
      ...
      <article className="border-t border-line/70 pt-8 first:border-t-0 first:pt-0">
        ...
        <p className="mt-2 text-sm leading-7 text-foreground-soft">
          Coding agents run as processes like any other, but they can also report their own lifecycle — started, waiting on you, done — through <code>spaces agent event</code>. The dashboard surfaces those states so you know which agent needs you next.
        </p>
      </article>
    </DocsShell>
  );
