...
MUXY_WORKSPACE_DIR              # this workspace's directory`}</code>
      ...
      <article className="border-t border-line/70 pt-8 first:border-t-0 first:pt-0">
        ...
        <p className="mt-2 text-sm leading-7 text-foreground-soft">
          Coding agents run as processes like any other, but they can also report their own lifecycle — started, waiting on you, done — through <code>mx agent event</code>. The dashboard surfaces those states so you know which agent needs you next.
        </p>
      </article>
    </DocsShell>
  );
