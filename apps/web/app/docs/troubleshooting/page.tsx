    ...
    >
      <article className="border-t border-line/70 pt-8 first:border-t-0 first:pt-0">
        ...
        <ol className="mt-3 space-y-2 text-sm leading-7 text-foreground-soft">
          ...
          <li>4. If launch complains about existing runtime, run <code>mx workspace up --restart</code>.</li>
        </ol>
      </article>
      ...
      <article className="border-t border-line/70 pt-8 first:border-t-0 first:pt-0">
        ...
        <ul className="mt-3 space-y-2 text-sm leading-7 text-foreground-soft">
          <li>• <strong>&ldquo;Workspace is already running&rdquo;</strong> &mdash; use <code>mx workspace up --restart</code> to reset state.</li>
        ...
        <pre className="mt-3 w-full max-w-full min-w-0 overflow-x-auto whitespace-pre-wrap break-words rounded-lg border border-line/70 bg-background-soft/60 p-3 text-xs leading-6 text-foreground">
          <code>{`mx workspace up /path/to/workspace
mx workspace up /path/to/workspace --restart
mx workspace up /path/to/workspace --focus frontend`}</code>
        </pre>
      </article>
