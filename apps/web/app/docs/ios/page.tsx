  ...
  return (
    ...
    >
      <Card>
        <div className="grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,18rem)]">
          <div className="min-w-0">
            <SectionHeading>Check on your coding agents from anywhere</SectionHeading>
      ...
      <Card>
        <div className="grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,18rem)]">
          <div className="min-w-0">
            <SectionHeading>Jump into any session</SectionHeading>
            <ul className="mt-3 space-y-2 text-sm leading-7 text-foreground-soft">
      ...
      <Section title="Open browser sessions on your phone">
        <ul className="mt-3 space-y-2 text-sm leading-7 text-foreground-soft">
      ...
      <Section title="The Mac app is never in the middle">
        <ul className="mt-3 space-y-2 text-sm leading-7 text-foreground-soft">
      ...
      <Section title="Try Spaces without a Mac">
        <ul className="mt-3 space-y-2 text-sm leading-7 text-foreground-soft">
      ...
      <Card>
        <div className="flex flex-wrap items-center gap-3">
          <SectionHeading>Pairing</SectionHeading>
        ...
        <ul className="mt-3 space-y-2 text-sm leading-7 text-foreground-soft">
          ...
          <li>• Once paired, your phone reconnects from the local network or over Tailscale — if you&apos;re away from home, keep Tailscale connected on your phone and the paired device and Spaces finds it automatically. For a cloud VM or a machine you reach from changing networks, set it up as described in <a className="text-accent hover:underline" href="/docs/remote-access">Remote Access</a> first.</li>
