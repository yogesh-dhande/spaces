    ...
    enum GhosttyEmbeddedKeyEvent {
        ...
        private static let functionKeycodes: [Int: UInt32] = [
            1: UInt32(kVK_F1), 2: UInt32(kVK_F2), 3: UInt32(kVK_F3), 4: UInt32(kVK_F4), 5: UInt32(kVK_F5), 6: UInt32(kVK_F6), 7: UInt32(kVK_F7),
            8: UInt32(kVK_F8), 9: UInt32(kVK_F9), 10: UInt32(kVK_F10), 11: UInt32(kVK_F11), 12: UInt32(kVK_F12),
        ]
