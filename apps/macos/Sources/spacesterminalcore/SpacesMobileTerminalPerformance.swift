...
public enum SpacesMobileTerminalPerformanceLogger {
    ...
    public static func emit(_ event: SpacesMobileTerminalPerformanceEvent, environment: [String: String] = ProcessInfo.processInfo.environment) {
