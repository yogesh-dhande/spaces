...
public enum ThemeRegistry {
    ...
    public static func descriptor(id: ThemeID?) -> ThemeDescriptor {
        themes.first { $0.id == id } ?? spacesBrand
    }
    ...
    private static let spacesBrandLightTerminal = GhosttyThemeExport(
        ...
        palette: [
            ThemeColor(16, 32, 40), ThemeColor(198, 58, 47), ThemeColor(58, 158, 95), ThemeColor(208, 122, 26),
            ThemeColor(52, 101, 164), ThemeColor(136, 84, 160), ThemeColor(15, 122, 118), ThemeColor(111, 132, 141),
            ThemeColor(58, 77, 87), ThemeColor(224, 82, 70), ThemeColor(72, 180, 112), ThemeColor(226, 140, 42),
            ThemeColor(66, 120, 190), ThemeColor(156, 100, 180), ThemeColor(13, 95, 93), ThemeColor(248, 247, 241),
        ])
    ...
    private static let spacesBrandDarkTerminal = GhosttyThemeExport(
        ...
        palette: [
            ThemeColor(23, 33, 36), ThemeColor(255, 107, 96), ThemeColor(76, 208, 122), ThemeColor(245, 167, 66),
            ThemeColor(122, 162, 210), ThemeColor(187, 128, 204), ThemeColor(89, 219, 205), ThemeColor(173, 192, 196),
            ThemeColor(63, 84, 88), ThemeColor(255, 138, 128), ThemeColor(106, 224, 146), ThemeColor(250, 190, 102),
            ThemeColor(150, 185, 225), ThemeColor(210, 150, 222), ThemeColor(121, 230, 219), ThemeColor(234, 240, 239),
        ])
    ...
    private static let spacesBrandLight = ThemeAppearanceTokens(
        ...
        rowHover: ThemeColor(15, 32, 40, alpha: 0.04), rowSelected: ThemeColor(15, 122, 118, alpha: 0.14),
    ...
    private static let spacesBrandDark = ThemeAppearanceTokens(
        background: ThemeColor(15, 21, 23), surface: ThemeColor(29, 42, 45), surface2: ThemeColor(23, 33, 36),
        paletteSurface: ThemeColor(25, 37, 40), sidebarBackground: ThemeColor(15, 21, 23), text: ThemeColor(234, 240, 239),
        muted: ThemeColor(173, 192, 196), mutedSecondary: ThemeColor(122, 138, 141), border: ThemeColor(48, 67, 70),
        borderStrong: ThemeColor(63, 84, 88), accent: ThemeColor(89, 219, 205), accentStrong: ThemeColor(61, 198, 184),
        accentTint: ThemeColor(89, 219, 205, alpha: 0.16), onAccent: ThemeColor(15, 21, 23), primaryButtonFill: ThemeColor(61, 198, 184),
        primaryButtonText: ThemeColor(15, 21, 23), green: ThemeColor(76, 208, 122), red: ThemeColor(255, 107, 96),
        orange: ThemeColor(245, 167, 66), rowHover: ThemeColor(234, 240, 239, alpha: 0.06), rowSelected: ThemeColor(89, 219, 205, alpha: 0.18),
