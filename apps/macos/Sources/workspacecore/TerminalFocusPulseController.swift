    ...
    public final class TerminalFocusPulseController: TerminalFocusPulseControlling, Sendable {
        public init(pulseDuration _: Duration = .milliseconds(300)) {}
        public func pulse(windowID _: Int, color _: (r: Int, g: Int, b: Int), yabai _: YabaiAdapter) {}
    }
#endif
