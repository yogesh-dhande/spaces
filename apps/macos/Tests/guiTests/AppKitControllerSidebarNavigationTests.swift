...
@Suite struct AppKitControllerSidebarNavigationTests {
    @Test func downArrowFromDashboardSelectsFirstVisibleWorkspace() {
        let target = AppKitController.sidebarArrowSelectionTarget(
            visibleWorkspaceIDsByProject: [("project-a", ["workspace-a", "workspace-b"]), ("project-b", ["workspace-c"])], selectedProjectID: nil,
            selectedWorkspaceID: nil, showingDashboard: true, direction: 1)
    ...
    @Test func downArrowFromLastWorkspaceStopsAtEndOfList() {
        let target = AppKitController.sidebarArrowSelectionTarget(
            visibleWorkspaceIDsByProject: [("project-a", ["workspace-a", "workspace-b"])], selectedProjectID: "project-a",
    ...
    @Test func collapsedProjectSelectionSkipsToNextVisibleWorkspace() {
        let target = AppKitController.sidebarArrowSelectionTarget(
            ...
            selectedProjectID: "project-a", selectedWorkspaceID: "workspace-a1", showingDashboard: false, direction: 1)
