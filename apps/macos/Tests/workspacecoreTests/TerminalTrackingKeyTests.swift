...
@Suite struct TerminalTrackingKeyTests {
    @Test func runningProcessFocusIdentityPrefersNativeSessionID() {
        let record = RunningProcessRecord(
            ...
            windowID: 101, terminalTrackingID: nil, terminalNativeID: "native-session-1", terminalContainerID: nil, pid: nil, status: .running,
    ...
    @Test func windowFocusIdentityPrefersNativeSessionID() {
        let record = WindowRecord(
            ...
            windowID: 101, terminalTrackingID: nil, terminalNativeID: "native-session-2", terminalContainerID: nil, role: "terminal", orderIndex: 0,
            lastSeenAt: "now")
