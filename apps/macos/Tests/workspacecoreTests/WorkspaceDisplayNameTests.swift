...
final class WorkspaceDisplayNameTests: XCTestCase {
    ...
    func testGitWorkspaceDisplayNameIsBranch() {
        let record = WorkspaceRecord(
            id: "ws", projectID: "p", dir: "/repos/app/almond", dirname: "almond", branch: "feature/login", isDefault: false, isArchived: false,
    ...
    func testNonGitWorkspaceDisplayNameIsFolderName() {
        let record = WorkspaceRecord(
            id: "ws", projectID: "p", dir: "/Users/me/notes", dirname: nil, branch: nil, isDefault: true, isArchived: false, isRunning: false,
            lastLaunchedAt: nil)
    ...
    func testEmptyBranchFallsBackToFolderName() {
        let summary = WorkspaceSummary(id: "ws", branch: "", dir: "/Users/me/scratch", isRunning: false, isArchived: false, isDefault: false)
