...
@MainActor
@Suite(.serialized)
final class MainWindowCloseBehaviorTests {
    ...
    private func makeWindow() -> NSWindow {
        NSWindow(contentRect: NSRect(x: 0, y: 0, width: 200, height: 200), styleMask: [.titled, .resizable, .closable], backing: .buffered, defer: false)
    }
