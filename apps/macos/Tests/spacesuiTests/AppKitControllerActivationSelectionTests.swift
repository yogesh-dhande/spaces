...
@Suite struct AppKitControllerActivationSelectionTests {
    ...
    @Test func observedRemoteRoutedBrowserURLResolvesWorkspace() {
        let overview = SpacesDeviceOverviewPayload(
            ...
            workspaces: [
                SpacesDeviceWorkspaceSummary(
                    id: "workspace", projectID: "project", projectName: "Project", branch: "feature-123", baseBranch: "main",
                    dir: "/project-feature", isRunning: true, isArchived: false, isHidden: false, isDefault: false, sessionCount: 0,
        ...
        let workspaceID = AppKitController.workspaceIDForObservedBrowserURL(
            "http://web.feature-123.localhost:7391/docs", in: [overview])
