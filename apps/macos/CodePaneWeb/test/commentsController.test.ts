...
function makeBridge(): SpacesBridge & {
  ...
  const bridge = {
    ...
    workspaceImageRead: notUsed,
    workspaceRevisionFileRead: notUsed,
    workspaceFileWrite: notUsed,
    workspaceFileCreateDirectory: notUsed,
    workspaceFileRename: notUsed,
    workspaceFileDelete: notUsed,
    openInSystemViewer: notUsed,
    workspaceFileList: notUsed,
    workspaceRefList: notUsed,
    subscribeDiffSignature: () => () => {},
    subscribeFileListSignature: () => () => {},
    subscribeFileSignature: () => () => {},
    unsubscribeFileSignature: () => {},
    notifyWorkspaceStateChanged: () => {},
    notifyRenderMetric: () => {},
    notifyEditsFlushed: () => {},
    retargetFileSignature: () => {},
    notifyReady: () => {},
