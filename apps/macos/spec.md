    ...
    - Workspace
        - fields
            ...
            - name: str, defaults to the branch name in the create form for git projects; user can edit during creation or later
                ...
                - default workspace name remains fixed as `default`; non-default workspaces can be renamed later
...
- User flow
    ...
    - User creates a project by either pointing to a local dir or providing a git repository URL
        ...
        - User can edit workspace settings later (including name for non-default workspaces); changes are stored in the db and applied immediately if the workspace is running
            ...
            - Loop through running workspaces (skips any workspaces that are not launched yet)
                ...
                - When a workspace is selected
                    ...
                    - `cmd+shift+return` focuses the selected workspace
                        ...
                        - when tooltip overlay is displayed for the focused workspace, it always shows workspace name as title and shows tooltip text as body content when present
