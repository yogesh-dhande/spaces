...
Complete guide for releasing a new version of Spaces.
...
2. ✅ Code sign `Spaces` and `spaces` binaries
...
│   └── 0.2.0/
│       └── Spaces-0.2.0.dmg      # Long cache (immutable)
└── [Next.js static site files]
```

### URLs After Deployment
- **Download**: `https://spaces-dev.web.app/releases/latest`
- **Appcast**: `https://spaces-dev.web.app/releases/appcast.xml`
- **Direct DMG**: `https://spaces-dev.web.app/releases/0.2.0/Spaces-0.2.0.dmg`
- **Website**: `https://spaces-dev.web.app/`
