...
- A row's leading status dot speaks one vocabulary everywhere: a haloed green dot for something running, a solid green dot for something enabled and healthy but idle, a hollow red dot for something stopped or failed, a hollow muted dot for something switched off or never started, and a solid orange dot for something waiting.
