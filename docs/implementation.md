...
flowchart TD
  ...
  app -->|SSH BatchMode bootstrap over stdin\nOpenSSH auth; strict known-host checking; passes profile root, runtime root, port, and token outside argv| sshd
  sshd --> remoteSpacesd
