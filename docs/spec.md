...
- The workspace detail footer should show inline shortcut hints for Toggle app, Palette, Settings, Open editor, New terminal, Next window, and Prev window, in that order.
